...
int main(int argc, char **argv) {
  ...
  if (argc!=12)
  {
    std::cerr<<"\n\nUSE: hashchecker <path/ReadFile1> <file_extension1> <input_file_number1> <path/ReadFile2>  <file_extension2>  <input_file_number2> <path/OutputFile> <k-mer_size>  <thread> <hash_size> <collision_list_size>\n\n";
    exit(EXIT_FAILURE);
  }
